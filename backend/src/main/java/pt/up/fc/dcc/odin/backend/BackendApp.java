package pt.up.fc.dcc.odin.backend;

import pt.up.fc.dcc.odin.backend.client.OAuth2InterceptedFeignConfiguration;
import pt.up.fc.dcc.odin.backend.config.ApplicationProperties;
import pt.up.fc.dcc.odin.backend.config.DefaultProfileUtil;
